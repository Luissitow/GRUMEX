const redes = [
  {
    nombre: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61578197236389',
  ...
  {
    nombre: 'Instagram',
    href: 'https://www.instagram.com/grumex_mx/',
  ...
  {
    nombre: 'TikTok',
    href: 'https://www.tiktok.com/@grumex_mx',
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          <h3 className="border-b border-white pb-2 text-xl font-bold">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="animate-gradient bg-gradient-to-r from-[#00D9F5] via-[#00F5A0] to-[#9D00FF] bg-[length:400%_100%] bg-clip-text font-semibold text-transparent"
            >
              Hecho por Zyber Company
            </a>
          </h3>
